...
package RP2350_SVD.ROSC is
   ...
   --  to 7 MEDIUM uses stages 0 to 5 HIGH uses stages 0 to 3 TOOHIGH uses
   --  stages 0 to 1 and should not be used because its frequency exceeds
   ...
   type CTRL_Register is record
      ...
      --  0 to 7 MEDIUM uses stages 0 to 5 HIGH uses stages 0 to 3 TOOHIGH uses
      --  stages 0 to 1 and should not be used because its frequency exceeds

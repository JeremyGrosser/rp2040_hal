...
package RP2350_SVD.PIO is
   ...
   type SM0_EXECCTRL_Register is record
      ...
      --  behaviour.
      STATUS_N      : SM0_EXECCTRL_STATUS_N_Field := RP2350_SVD.PIO.IRQ;
      --  Comparison used for the MOV x, STATUS instruction.
      STATUS_SEL    : SM0_EXECCTRL_STATUS_SEL_Field :=
                       RP2350_SVD.PIO.TXLEVEL;
   ...
   type SM1_EXECCTRL_Register is record
      ...
      --  than the current FIFO depth are reserved, and have undefined
      --  behaviour.
      STATUS_N      : SM1_EXECCTRL_STATUS_N_Field := RP2350_SVD.PIO.IRQ;
      --  Comparison used for the MOV x, STATUS instruction.
   ...
   type SM2_EXECCTRL_Register is record
      ...
      --  than the current FIFO depth are reserved, and have undefined
      --  behaviour.
      STATUS_N      : SM2_EXECCTRL_STATUS_N_Field := RP2350_SVD.PIO.IRQ;
      --  Comparison used for the MOV x, STATUS instruction.
   ...
   type SM3_EXECCTRL_Register is record
      ...
      --  than the current FIFO depth are reserved, and have undefined
      --  behaviour.
      STATUS_N      : SM3_EXECCTRL_STATUS_N_Field := RP2350_SVD.PIO.IRQ;
      --  Comparison used for the MOV x, STATUS instruction.
   ...
   PIO2_Periph : aliased PIO_Peripheral

...
package body RP.Clock is
   ...
   --  Table 543. CLK_GPOUT0_CTRL Register
   type CLK_CTRL_AUXSRC_Field is
      (PLL_SYS, GPIN0, GPIN1, PLL_USB, PLL_USB_PRIMARY_REF_OPCG, ROSC, XOSC,
       LPOSC, SYS, USB, ADC, REF, PERI, HSTX, OTP_CLK2FC)
      with Size => 4;
   ...
   --  REF_SRC_LPOSC  : constant CLK_CTRL_SRC_Field := 3;
   ...
   CLOCKS_Periph : aliased CLOCKS_Peripheral
      with Import, Address => RP2350_SVD.CLOCKS_Base;
